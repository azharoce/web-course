...
<div class="container p-0">
    ...
    <div class="bg-blue-600 md:rounded-b-lg px-8 lg:-mt-5 pt-12 pb-8 relative overflow-hidden" style="background: #1877f2;">

        <div class="lg:w-9/12 relative z-10">

            <div class="uppercase text-gray-200 mb-2 font-semibold">Web develpment</div>
            <h1 class="lg:leading-10 lg:text-3xl text-white text-2xl leading-8 font-semibold"> Learn JavaScript from scratch to become a professional JavaScript developer. </h1>
            <p class="lg:w-3/4 mt-4 text-gray-200"> Master JavaScript with the most complete course! Projects Excellent course. we explain the core concepts in javascript 
        ...
        <img src="https://demo.foxthemes.net/courseplus/assets/images/courses/course-intro.png" alt="" class="absolute bottom-0 right-0 hidden lg:block">
    ...
    <div class="lg:flex lg:space-x-4 mt-4">
        <div class="lg:w-8/12 space-y-4">
            ...
            <!-- course Curriculum -->
            <div class="tube-card p-5 lg:p-8"  id="curriculum">
            ...
            <div id="announcement" class="tube-card p-5 lg:p-8">
                ...
                <div class="flex items-center gap-x-4 mb-5">
                    <img src="https://demo.foxthemes.net/courseplus/assets/images/avatars/avatar-4.jpg" alt="" class="rounded-full shadow w-12 h-12">
                    <div>
            ...
            <div id="reviews" class="tube-card p-5 lg:p-8">
                ...
                <div class="space-y-4 my-5">
                    ...
                    <div class="bg-gray-50 border flex gap-x-4 p-4 relative rounded-md">
                        ...
                        <img src="https://demo.foxthemes.net/courseplus/assets/images/avatars/avatar-2.jpg" alt="" class="rounded-full shadow w-12 h-12">
                        <div>
                    ...
                    <div class="bg-gray-50 border flex gap-x-4 p-4 relative rounded-md lg:ml-16">
                        ...
                        <img src="https://demo.foxthemes.net/courseplus/assets/images/avatars/avatar-3.jpg" alt="" class="rounded-full shadow w-12 h-12">
                        <div>
                ...
                <div class="p-1">
                    <a href="#" class="-mx-3 block hover:bg-gray-100 p-2 rounded-md">
                        <div class="flex items-center space-x-3">
                            <img src="https://demo.foxthemes.net/courseplus/assets/images/courses/img-2.jpg" alt="" class="h-12 object-cover rounded-md w-12">
                    ...
                    <a href="#" class="-mx-3 block hover:bg-gray-100 p-2 rounded-md">
                        <div class="flex items-center space-x-3">
                            <img src="https://demo.foxthemes.net/courseplus/assets/images/courses/img-4.jpg" alt="" class="h-12 object-cover rounded-md w-12">
                            <div class="line-clamp-2 text-sm font-medium"> 
                                The Complete JavaScript From beginning to Experts for advance
                            </div>
                        </div>
                    ...
                    <a href="#" class="-mx-3 block hover:bg-gray-100 p-2 rounded-md">
                        <div class="flex items-center space-x-3">
                            <img src="https://demo.foxthemes.net/courseplus/assets/images/courses/img-3.jpg" alt="" class="h-12 object-cover rounded-md w-12">
                            <div class="line-clamp-2 text-sm font-medium"> 
                                The Complete JavaScript From beginning to Experts for advance
                            </div>
                        </div>
